        ...
        <section className="w-full lg:w-7/12 p-8 sm:p-12 xl:p-16 flex flex-col justify-center bg-white">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 rounded-lg bg-white text-slate-700 font-medium hover:bg-slate-50 transition-colors" type="button">
